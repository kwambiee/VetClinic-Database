...
explain analyze select * from visits INNER JOIN animalidentification ON  visits.animals_id=animalidentification.id WHERE animalidentification.id=4 LIMIT 50000;
